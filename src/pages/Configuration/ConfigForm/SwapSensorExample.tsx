...
export const SwapSensorExample = () => {
  return (
    <Tooltip.Root>
      ...
      <Tooltip.Positioner>
        <Tooltip.Content
          ...
          color="fg.default"
          style={{ "min-width": "31.5rem" }}
        >
          <div style={{ display: "flex", width: "30rem", height: "10rem" }}>
            <div style={{ width: "14rem", height: "9rem" }}>
              <Text>{"Before Swap"}</Text>
              <div
                style={{
                  width: "100%",
                  height: "100%",
