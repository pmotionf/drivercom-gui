...
import { LogConfigureForm } from "./LogConfigure/LogConfigureForm";
    ...
    <>
      <div style={{ "margin-left": "calc(100% / 3)", "padding-top": "3rem" }}>
        ...
        <Show when={isFileOpen()}>
          ...
          <LogConfigureForm jsonfile={logConfigureFile()} />
        </Show>
      </div>
    </>
  );
