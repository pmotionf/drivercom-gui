...
export type LogViewerTabListProps = JSX.HTMLAttributes<HTMLDivElement> & {
  id: string;
  tabList: [string, string, number[][], PlotContext[], string, number | null][]; // tabId, filePath, split index array, tab name
  onCreateTab?: () => void;
  ...
  onXRangeChange?: (id: string, xRange: number) => void;
            ...
            {(
              ...
              >
                <LogViewerTabPageContent
                  ...
                  onXRangeChange={(xRange) => props.onXRangeChange?.(currentTabId, xRange)}
                />
              </Tabs.Content>
            )}
          </For>
